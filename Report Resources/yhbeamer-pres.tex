...
\logo{\includegraphics[width=45pt]{get_bretag_cont_quad.pdf}
...
\newtheorem{theo}[prop]{Th\'eor\`eme}
\newtheorem{lemm}[prop]{Lemme}
\newtheorem{coro}[prop]{Corollaire}
\newtheorem{defifr}[prop]{D\'efinition}
\newtheorem{defien}[prop]{Definition}
\newtheorem{defis}[prop]{D\'efinitions}
